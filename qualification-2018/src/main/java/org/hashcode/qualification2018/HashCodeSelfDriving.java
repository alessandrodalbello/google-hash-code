...
import org.hashcode.qualification2018.solvers.FleetSchedulerSolverFactory;
...
public class HashCodeSelfDriving extends HashCodeRunner<SelfDrivingInput, SelfDrivingOutput> {
    ...
    public static void main(String[] arguments) {
        ...
        for (String argument : arguments) {
            ...
            Solver<SelfDrivingInput, SelfDrivingOutput> solver = FleetSchedulerSolverFactory.byLatestFinishTimeAnyVehicleWhichCompletes();
